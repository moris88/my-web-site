					...
					<div className="mt-16 flex w-full flex-col items-center gap-10">
						...
						>
							{[
								...
								{
									title: 'Backend Core',
									skills: ['Node.js', 'Express.js', 'Supabase', 'REST APIs', 'Strapi', 'Drupal', 'Wordpress'],
									color: 'from-green-500/10 to-emerald-500/10',
									icon: <Code className="text-green-500" />,
								},
								{
									title: 'Database',
									skills: ['PostgreSQL', 'MySQL', 'MongoDB', 'SQLite', 'MariaDB', 'DynamoDB'],
									color: 'from-purple-500/10 to-pink-500/10',
									icon: <Code className="text-purple-500" />,
								},
								{
									title: 'Tools & Design',
									skills: ['Git & GitHub', 'Figma', 'Biome.js', 'Vite.js', 'ESLint', 'Prettier'],
